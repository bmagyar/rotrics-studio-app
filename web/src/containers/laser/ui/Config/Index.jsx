        ...
        return (
            <div style={{
                ...
                <Space direction={"vertical"} size="small"
                    ...
                    <div style={{width: "100%"}}>
                        <ActionButton onClick={actions.startTask} text={t("Start Send G-code")}
                                      style={{width: "calc(50% - 4px)", marginRight: "8px"}}/>
                        <ActionButton onClick={actions.stopTask} text={t("Stop Send G-code")}
                                      style={{width: "calc(50% - 4px)"}}/>
                    </div>
                    <div style={{width: "100%"}}>
                        <ActionButton onClick={actions.pauseTask} text={t("Pause Send G-code")}
                                      style={{width: "calc(50% - 4px)", marginRight: "8px"}}/>
