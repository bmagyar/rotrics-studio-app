...
class Transformation extends PureComponent {
    ...
    render() {
        const {t} = this.props;
        const { model, transformation, advance, isLockScale } = this.props;
...
const mapStateToProps = (state) => {
    const { model, transformation, isLockScale } = state.writeAndDraw;
...
const mapDispatchToProps = (dispatch) => {
    return {
        updateTransformation: (key, value, preview, isLockScale) => dispatch(writeAndDrawActions.updateTransformation(key, value, preview, isLockScale)),
        toggleIsLockScale: () => dispatch(writeAndDrawActions.toggleIsLockScale())
    };
};
